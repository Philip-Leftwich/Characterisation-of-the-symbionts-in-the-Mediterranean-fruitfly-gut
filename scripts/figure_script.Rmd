...
Bar plot of the top 20 most frequent OTUs across all samples identified to Genus level
...
```
Let’s run the plot_ordination command on the samples instead of the OTUs. We can use the same ordination object as above.
```{r}
####
...
####then run a glm on this new dataset to look at significant predictors of community richness
